...
- **Chunks are never stored.** A message reaches the file once, whole. Text merges by ACP `messageId`; a changed id settles the previous message, and text with no id stays open until the turn ends.
