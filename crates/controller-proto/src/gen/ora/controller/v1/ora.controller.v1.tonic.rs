...
pub mod controller_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn accept_clone(
            &mut self,
            request: impl tonic::IntoRequest<super::AcceptCloneRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AcceptCloneResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/ora.controller.v1.ControllerService/AcceptClone",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("ora.controller.v1.ControllerService", "AcceptClone"),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ora.controller.v1.ControllerService/ListOperations",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "ora.controller.v1.ControllerService",
                        "ListOperations",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ora.controller.v1.ControllerService/GetOperation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod controller_service_server {
    ...
    pub trait ControllerService: std::marker::Send + std::marker::Sync + 'static {
        async fn accept_clone(
            &self,
            request: tonic::Request<super::AcceptCloneRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AcceptCloneResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/ora.controller.v1.ControllerService/AcceptClone" => {
                    ...
                    struct AcceptCloneSvc<T: ControllerService>(pub Arc<T>);
                    impl<
                        T: ControllerService,
                    > tonic::server::UnaryService<super::AcceptCloneRequest>
                    for AcceptCloneSvc<T> {
                        type Response = super::AcceptCloneResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ControllerService>::accept_clone(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let fut = async move {
                        let method = AcceptCloneSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                ...
                "/ora.controller.v1.ControllerService/ListOperations" => {
                    #[allow(non_camel_case_types)]
                    struct ListOperationsSvc<T: ControllerService>(pub Arc<T>);
                    impl<
                        T: ControllerService,
                    ...
                    for ListOperationsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ControllerService>::list_operations(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/ora.controller.v1.ControllerService/GetOperation" => {
                    #[allow(non_camel_case_types)]
                    struct GetOperationSvc<T: ControllerService>(pub Arc<T>);
                    impl<
                        T: ControllerService,
                    ...
                    for GetOperationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ControllerService>::get_operation(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "ora.controller.v1.ControllerService";
