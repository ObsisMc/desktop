...
const translations = {
  "zh-CN": {
    ...
    "settings.privacy.clearHistoryDescription": "删除当前设备上保存的所有 Agent 对话，不会删除项目和工作树。",
    "settings.privacy.clear": "清除历史",
    "settings.privacy.clearTitle": "清除所有会话历史？",
    "settings.privacy.clearConfirm": "所有本地 Agent 对话都将被删除，此操作无法撤销。",
  ...
  "en-US": {
    ...
    "settings.privacy.clearHistoryDescription": "Delete all Agent conversations saved on this device without removing projects or worktrees.",
    "settings.privacy.clear": "Clear history",
    "settings.privacy.clearTitle": "Clear all conversation history?",
    "settings.privacy.clearConfirm": "All local Agent conversations will be deleted. This cannot be undone.",
