...
export const translationResources = {
  "zh-CN": {
    ...
    "settings.skills.marketplaceDescription": "浏览真实 SkillHub 市场，并将 ZIP 下载到 Ora 的应用数据目录。",
    ...
    "settings.skills.marketplaceDownloaded": "已下载 {{fileName}}",
  ...
  "en-US": {
    ...
    "settings.skills.marketplaceDescription": "Browse the live SkillHub marketplace and download ZIP archives into Ora application data.",
    ...
    "settings.skills.marketplaceDownloaded": "Downloaded {{fileName}}",
