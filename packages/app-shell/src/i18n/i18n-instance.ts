...
export const translationResources = {
  "zh-CN": {
    ...
    "diff.viewModeFocus": "切换为单文件视图",
    "diff.viewModeScroll": "切换为连续滚动视图",
    "diff.commit": "提交",
  ...
  "en-US": {
    ...
    "diff.viewModeFocus": "Switch to single-file view",
    "diff.viewModeScroll": "Switch to continuous scroll view",
    "diff.commit": "Commit",
